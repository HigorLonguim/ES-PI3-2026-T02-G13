...
class HelpPage extends StatelessWidget {
          ...
          children: [
              ...
              child: Column(
                children: [
                  _buildActionTile(
                    ...
                    onTap: () { /* Adicione navegação se tiver a tela */ },
                  ),
                  _divider(),
                  _buildActionTile(
            ...
            Container(
              ...
              child: const Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text('Horário de Atendimento:', style: TextStyle(color: Color(0xFF60A5FA), fontWeight: FontWeight.bold, fontSize: 15)),
                  SizedBox(height: 8),
                  Text('Segunda a Sexta: 9h às 18h\nSábado: 9h às 13h', style: TextStyle(color: Colors.white, fontSize: 14, height: 1.5)),
                ],
              ),
            ),
      ...
      child: ExpansionTile(
        ...
        children: [
          Padding(
            ...
            child: Text(answer, style: const TextStyle(color: Color(0xFF99A1AF), height: 1.5)),
          ),
        ],
      ),
    );
  ...
  Widget _divider() {
    return Divider(color: Colors.white.withValues(alpha: 0.05), height: 1, indent: 20, endIndent: 20);
  }
}